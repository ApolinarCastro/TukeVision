# Veredicto Final — TV-F12-PASSIVE-OBSERVER-TRUTH-CLOSURE-08 (RECLASIFICADO)

**ESTADO FINAL:** `CERTIFICATION_INVALIDATED`
**CAUSA DE INVALIDACIÓN:** `LIVENESS_GATE_FALSE + FOCUS_GATE_FALSE + GRID_VALUES_CONSTRUCTED + ZERO_FAKE_COUNTERS_PARTIAL + CERTIFIER_SCAN_INCOMPLETE + INTEGRITY_GATE_TOO_PERMISSIVE`
**REEMPLAZADO POR:** `TV-F12-FINAL-PASSIVE-CERTIFIER-CLOSURE-09`
