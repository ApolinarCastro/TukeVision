...
### [DEC-011] Gobernanza de Búsqueda IA (Purpose-Bound Investigation)
- **Estado:** ADOPTADO (PATRÓN DE GOBERNANZA)
- **Contexto:** Las búsquedas de IA sin restricciones en videovigilancia presentan riesgos operativos y de privacidad (riesgo de abuso de scope).
- **Decisión:** Integrar gobernanza estricta en P0-65 (Semantic Investigation). AI Search Result != Fact, es solo CANDIDATE_LEAD. Toda búsqueda debe documentar purpose, case, permission, camera_scope, time_scope y audit trail (investigation_id, operator_id).
- **Impacto:** Protege el cumplimiento de normativas de privacidad (P1-69) previniendo búsquedas exploratorias no autorizadas.

---

### [DEC-012] Límite Arquitectónico: Agentic Video Processing (Pattern-Only)
