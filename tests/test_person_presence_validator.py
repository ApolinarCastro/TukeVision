...
def test_real_person_stopping_remains_person(validator):
    ...
    # Still less than persistence but more than short stop threshold
    # Since persistence is 1.0s, we wait 0.6s
    # In validator: duration > 5.0 for PERSON_STATIONARY. We should mock time.time or just modify validator for test
    validator.fixture_persistence_seconds = 10.0
    validator.evaluate_track(track, None)
    
    # Hack first_seen to simulate 6 seconds
